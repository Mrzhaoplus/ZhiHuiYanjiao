...
public class TwoCardAdapter extends BaseAdapter {
    ...
    public TwoCardAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            ...
            switch (type) {
                case ONEPHOTO:
                    convertView = LayoutInflater.from(context).inflate(R.layout.frag_ershou1, null);
                    ...
                    break;
                case TWOHOTO:
                    convertView = LayoutInflater.from(context).inflate(R.layout.frag_ershou2, null);
                    holder.img_tou = (ImageView) convertView.findViewById(R.id.img_tou);
                    holder.text_name = (TextView) convertView.findViewById(R.id.text_name);
                    holder.da_address = (TextView) convertView.findViewById(R.id.da_address);
                    holder.imageView2 = (ImageView) convertView.findViewById(R.id.imageView2);
                    ...
                    break;
                case MANy:
                    convertView = LayoutInflater.from(context).inflate(R.layout.frag_ershou3, null);
                    holder.img_tou = (ImageView)     convertView .findViewById(R.id.img_tou);
                    holder.text_name = (TextView)     convertView .findViewById(R.id.text_name);
                    holder.da_address = (TextView)     convertView .findViewById(R.id.da_address);
                    holder.imageView2 = (ImageView)     convertView .findViewById(R.id.imageView2);
