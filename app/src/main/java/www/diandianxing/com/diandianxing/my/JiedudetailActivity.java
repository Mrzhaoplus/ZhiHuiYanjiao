...
public class JiedudetailActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jiedudetail);
        initView();
        ininview();
    }
    private void ininview() {
        WebView web_count = (WebView) findViewById(R.id.web_view);
        // 设置WebView的客户端
        ...
        web_count.loadUrl((MyContants.HTML+"Rules_interpretation.html" ));
    }
