...
import www.diandianxing.com.diandianxing.bean.GuanZhuTable;
 ...
 * author:衣鹏
*/
public class GuanzhuFragment extends BaseFragment implements PaiKeZZListener {
    ...
    protected void lazyLoad() {
        ...
        if(NetUtil.checkNet(getActivity())){
            ...
            List<GuanZhuTable> tujian = new ArrayList<>();

            tujian.addAll(DataSupport.findAll(GuanZhuTable.class));

            for(int i=0;i<tujian.size();i++){

                GuanZhuTable tuijianTable = tujian.get(i);
            ...
            if(tujianadapter==null){
                tujianadapter=new Tujianadapter(getActivity(),list,GuanzhuFragment.this);
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        try {
                            ...
                            List<GuanZhuTable> guanZhuTables = new ArrayList<GuanZhuTable>();
                            if (code == 200) {
                                for(int i=0;i<datas.length();i++){

                                    JSONObject jo = datas.getJSONObject(i);
                                    PaiKeInfo paiKeInfo = new PaiKeInfo();
                                    GuanZhuTable t = new GuanZhuTable();
                                ...
                                if(pageNo>1){
                                    ...
                                    if(paiKeInfos.size()<=0){
                                        ...
                                        DataSupport.saveAll(guanZhuTables);
                                    }
                                    tv_yw_content.setVisibility(View.GONE);
                                }else{
                                    DataSupport.deleteAll(GuanZhuTable.class);
                                    if(paiKeInfos.size()==0){
