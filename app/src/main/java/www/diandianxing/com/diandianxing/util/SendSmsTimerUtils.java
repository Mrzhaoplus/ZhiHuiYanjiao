...
//        mTextView.setEnabled(false);
//        mTextView.setText(millisUntilFinished / 1000 + "S");
//        mTextView.setTextColor(Myapplication.getGloableContext().getResources().getColor(R.color.text_orage));
//
//        SpannableString spannableString = new SpannableString(mTextView.getText().toString());
//        ForegroundColorSpan span = new ForegroundColorSpan(Myapplication.getGloableContext().getResources().getColor(R.color.text_orage));
//        //设置秒数为红色
