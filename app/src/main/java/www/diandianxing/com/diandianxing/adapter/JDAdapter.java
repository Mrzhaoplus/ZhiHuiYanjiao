...
public class JDAdapter extends BaseQuickAdapter<GuanzhuJD, BaseViewHolder> {
    ...
    public JDAdapter(@LayoutRes int layoutResId, @Nullable List<GuanzhuJD> data, String title, StateClickListener stateClickListener) {
    ...
    protected void convert(final BaseViewHolder helper, final GuanzhuJD item) {
        ...
        iv_ddd.setVisibility(View.VISIBLE);
...
//        }
        ...
        text_share.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mOnItemClickListener.FxClickListener(helper.getAdapterPosition(),"每日郊点");
            }
        });
