...
public class SearchLocationAdapter extends BaseQuickAdapter<PoiAddressBean, BaseViewHolder> {

    public SearchLocationAdapter(@LayoutRes int layoutResId, @Nullable ArrayList<PoiAddressBean> data) {
