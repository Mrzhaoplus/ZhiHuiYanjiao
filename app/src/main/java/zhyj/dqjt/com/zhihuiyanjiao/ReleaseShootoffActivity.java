...
public class ReleaseShootoffActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        rv_fbfl.setLayoutManager(new GridLayoutManager(ReleaseShootoffActivity.this,4));
        rv_fbfl.setNestedScrollingEnabled(false);

        final TagAdapter tagAdapter  = new TagAdapter(R.layout.type_item_view, mList,ReleaseShootoffActivity.this);
